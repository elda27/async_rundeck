...
class Jvm(BaseModel):
    ...
    version: Optional[String] = Field(alias='version')
    implementation_version: Optional[String] = Field(alias=
...
class Storage(BaseModel):
    ...
    incomplete_filetypes: Optional[List[String]] = Field(alias=
        'incompleteFiletypes')
...
class TakeoverScheduleResponse(BaseModel):
    takeover_schedule: Optional[TakeoverSchedule] = Field(alias=
        'takeoverSchedule')
...
class Meta(BaseModel):
    rundeck_key_type: Optional[StorageKeyMetaType] = Field(alias=
        'Rundeck-key-type')
...
class ExecutionState(BaseModel):
    ...
    execution_state: Optional["ExecutionStateState"] = Field(alias=
        'executionState')
    completed: Boolean = Field(alias='completed')
