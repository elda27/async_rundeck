...
incomplete_file_type: Optional[IncompleteFileType] = Field(alias="IncompleteFileType")
...
storage_key_meta_type: Optional[StorageKeyMetaType] = Field(alias="StorageKeyMetaType")
...
execution_state_state: Optional[ExecutionStateState] = Field(
    alias="ExecutionStateState"
)
